...
import SafehousePage from './pages/SafehousePage';
    ...
    <>
      ...
      <Routes>
        ...
        <Route path="/" element={<ProtectedRoute><GameLayout /></ProtectedRoute>}>
          ...
          <Route path="scratch" element={<Navigate to="/more" replace />} />
          <Route path="territories" element={<Navigate to="/more" replace />} />
          <Route path="achievements" element={<Navigate to="/more" replace />} />
          <Route path="social" element={<Navigate to="/more" replace />} />
          <Route path="crew" element={<Navigate to="/mob" replace />} />
          <Route path="revenge" element={<Navigate to="/fight" replace />} />
