...
/** iMobsters (Storm8) menu — no iMob 2 casino/territory extras */
const LINKS = [
...
export default function MorePage() {
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-gray-500">Original iMobsters features — red & black Storm8 style</p>

      <div className="grid grid-cols-3 gap-2">
        {LINKS.map((l) => (
          <Link key={l.label} to={l.to} className="card flex flex-col items-center py-3 px-1 hover:border-red-700/50 transition-colors text-center min-h-[88px]">
      ...
      {state?.economy && (
        <div className="card text-sm border-red-900/30">
      ...
      <div className="card text-xs text-gray-500 text-center border-red-950/30">
